...
在main函数中按注释提示修改begin_id和end_id。注意end_id比实际爬到的帖子多1。以爬取第2003到第2004个帖子为例，修改begin_id=2003，end_id=**2005**。点击上方横置三角形运行按钮。程序启动，等待其执行完毕即可在同目录下查看爬取的文本。

![image-20210402200925927](images/0ddd.gif)  
